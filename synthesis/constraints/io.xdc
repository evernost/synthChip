...
# Purpose       : I/O constraints for the synthChip FPGA (target = zedboard)
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {user_leds[0]}];
set_property PACKAGE_PIN T21 [get_ports {user_leds[1]}];
set_property PACKAGE_PIN U22 [get_ports {user_leds[2]}];
set_property PACKAGE_PIN U21 [get_ports {user_leds[3]}];
set_property PACKAGE_PIN V22 [get_ports {user_leds[4]}];
set_property PACKAGE_PIN W22 [get_ports {user_leds[5]}];
set_property PACKAGE_PIN U19 [get_ports {user_leds[6]}];
set_property PACKAGE_PIN U14 [get_ports {user_leds[7]}];
...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
# set_property PACKAGE_PIN Y21  [get_ports {display_data[0]}];
# set_property PACKAGE_PIN Y20  [get_ports {display_data[1]}];
# set_property PACKAGE_PIN AB20 [get_ports {display_data[2]}];
# set_property PACKAGE_PIN AB19 [get_ports {display_data[3]}];
# set_property PACKAGE_PIN AB22 [get_ports {display_data[4]}];
# set_property PACKAGE_PIN AA22 [get_ports {display_data[5]}];
# set_property PACKAGE_PIN AB21 [get_ports {display_data[6]}];
# set_property PACKAGE_PIN AA21 [get_ports {display_data[7]}];
# set_property PACKAGE_PIN V20  [get_ports {display_data[8]}];
# set_property PACKAGE_PIN U20  [get_ports {display_data[9]}];
# set_property PACKAGE_PIN V19  [get_ports {display_data[10]}];
# set_property PACKAGE_PIN V18  [get_ports {display_data[11]}];
# set_property PACKAGE_PIN AA19 [get_ports {display_hsync}];
# set_property PACKAGE_PIN Y19  [get_ports {display_vsync}];
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {push_button_C}];
set_property PACKAGE_PIN N15 [get_ports {push_button_L}];
set_property PACKAGE_PIN R18 [get_ports {push_button_R}];
set_property PACKAGE_PIN T18 [get_ports {push_button_U}];
set_property PACKAGE_PIN R16 [get_ports {push_button_D}];
...
# -----------------------------------------------------------------------------
# FMC Expansion Connector I2C - Bank 13
# -----------------------------------------------------------------------------
